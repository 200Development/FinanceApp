...
namespace FinanceApp.Data.Helpers
{
    public class ApiResult<T>
    {
        ...
        /// <returns>An object containing the IQueryable paged/sorted/filtered result and all the relevant paging/sorting/filtering navigation info.</returns>
        ...
        //    {
        //        var column = typeof(T).GetProperty(filterColumn);
        //        source = source.Where(s => s.column );
        //    }
